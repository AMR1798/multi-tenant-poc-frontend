                ...
                <div class="w-full lg:w-4/12 px-4">
                    <div
                        ...
                        <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                            <div class="text-gray-700 text-center mb-3 font-bold uppercase py-5">
                                {{ tenantStore.getTenant().name }} Register
                            </div>
                            <form>
                                ...
                                <div class="text-gray-700 text-center mb-3 uppercase py-5">
                                    Note: Do not use an actual email for this website if you want to register. Please use free temp email services instead.
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="flex flex-wrap mt-6 text-black dark:text-white">
                        ...
                        <div class="w-1/2 text-right">
                            <RouterLink to="/login" class=""><small>Login</small></RouterLink>
                        </div>
                    </div>
                </div>
            </div>
